package co.jave.testing.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (ex instanceof co.jave.testing.service.EmailAlreadyUsedException) return new EmailAlreadyUsedException()
            .getProblemDetailWithCause();
        if (ex instanceof co.jave.testing.service.UsernameAlreadyUsedException) return new LoginAlreadyUsedException()
            .getProblemDetailWithCause();
        if (ex instanceof co.jave.testing.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
        if (
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "co.jave.testing");
    }
}
